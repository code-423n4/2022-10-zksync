...
interface L2StandardERC20Interface extends ethers.utils.Interface {
  functions: {
    ...
    "bridgeInitialize(address,bytes)": FunctionFragment;
  ...
  events: {
    ...
    "BridgeInitialization(address,string,string,uint8)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "BridgeInitialization"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "BridgeMint"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Initialized"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Transfer"): EventFragment;
}

export class L2StandardERC20 extends Contract {
  ...
  functions: {
    ...
    "bridgeInitialize(address,bytes)"(
      _l1Address: string,
      _data: BytesLike,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
