...
interface DiamondUpgradeInitInterface extends ethers.utils.Interface {
  functions: {
    "forceDeployL2Contract(bytes,bytes[],uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "forceDeployL2Contract",
...
export class DiamondUpgradeInit extends Contract {
  ...
  interface: DiamondUpgradeInitInterface;

  functions: {
    forceDeployL2Contract(
      _forceDeployCalldata: BytesLike,
      _factoryDeps: BytesLike[],
      _ergsLimit: BigNumberish,
      overrides?: PayableOverrides
    ): Promise<ContractTransaction>;

    "forceDeployL2Contract(bytes,bytes[],uint256)"(
      _forceDeployCalldata: BytesLike,
      _factoryDeps: BytesLike[],
      _ergsLimit: BigNumberish,
      overrides?: PayableOverrides
