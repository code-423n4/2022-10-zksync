...
export class AllowList extends Contract {
  ...
  isAccessPublic(arg0: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    isAccessPublic(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
