...
interface GovernanceFacetTestInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernanceFacetTest extends Contract {
  ...
  interface: GovernanceFacetTestInterface;
